...
import org.cvit.cabig.dmr.common.DmrConstants;
import org.cvit.cabig.dmr.stubs.DmrResourceProperties;
import org.cvit.cabig.dmr.service.DmrConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class DmrResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(DmrResourceBase.class);

	private DmrResourceConfiguration configuration;
	...
	public gov.nih.nci.cagrid.metadata.dataservice.DomainModel getDomainModel(){
		return ((DmrResourceProperties) getResourceBean()).getDomainModel();
	}
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((DmrResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(DmrConstants.SERVICEMETADATA);
	...
	private void loadDomainModelFromFile() {
      if(getDomainModel()==null){
		try {
			...
			((DmrResourceProperties) this.getResourceBean()).setDomainModel((gov.nih.nci.cagrid.metadata.dataservice.DomainModel) Utils.deserializeDocument(dataFile.getAbsolutePath(),
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((DmrResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
