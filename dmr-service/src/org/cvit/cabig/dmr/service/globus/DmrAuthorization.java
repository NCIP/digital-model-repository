 ...
 * 
 */
public class DmrAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://dmr.cabig.cvit.org/Dmr";
	
	
	public DmrAuthorization() {
	}
	...
	public static void authorizeAddEntry() throws RemoteException {
		
		
	}
					
	public static void authorizeAddDataToEntry() throws RemoteException {
		
		
	}
					
	public static void authorizeAddReferenceToEntry() throws RemoteException {
		
		
	}
					
	public static void authorizeUpdateEntry() throws RemoteException {
		
		
	}
					
	public static void authorizeUpdateReference() throws RemoteException {
		
		
	}
					
	public static void authorizeUpdateData() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("addEntry")){
			try{
				authorizeAddEntry();
				return true;
			} catch (Exception e){
		...
		} else if(operation.getLocalPart().equals("addDataToEntry")){
			try{
				authorizeAddDataToEntry();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("addReferenceToEntry")){
			try{
				authorizeAddReferenceToEntry();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("updateEntry")){
			try{
				authorizeUpdateEntry();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("updateReference")){
			try{
				authorizeUpdateReference();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("updateData")){
			try{
				authorizeUpdateData();
				return true;
			} catch (Exception e){
