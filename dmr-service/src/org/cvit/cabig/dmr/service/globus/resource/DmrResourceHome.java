 ...
 * 
 */
public class DmrResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(DmrResourceHome.class);
    private static final UUIDGen UUIDGEN = UUIDGenFactory.getUUIDGen();

	public Resource createSingleton() {
		logger.info("Creating a single resource.");
		try {
		    DmrResourceProperties props = new DmrResourceProperties();
			DmrResource resource = new DmrResource();
			if (resource instanceof PersistenceCallback) {
                  ...
                  try{
                    ((PersistenceCallback) resource).load(null);
			          ...
			          resource.initialize(props, DmrConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
			      }
            } else {
                    resource.initialize(props, DmrConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
            }
	...
	public Resource find(ResourceKey key) throws ResourceException {
		DmrResource resource = (DmrResource) super.find(key);
		return resource;
	}
     ...
     */
    public DmrResource getAddressedResource() throws Exception {
        DmrResource thisResource;
        thisResource = (DmrResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}